...
/**
 * Top Down emptiness check for general script tree automata.
 * Intended for datalog interpretation, doesn't use nested terms.
 * @deprecated
 * @author Benedikt Nordhoff
 */
trait PrologTDEmptinessCheck extends ScriptTreeAutomata{
	def emptiness:String = {
		...
		append("%Top Down Emptinesscheck for " + name+ "\n")
