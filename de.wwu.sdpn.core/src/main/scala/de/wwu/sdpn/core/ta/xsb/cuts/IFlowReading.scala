 ...
 */
class IFlowReading[StackSymbol<%HasTermRepresentation](override val name:String,readingStack:Set[StackSymbol]) extends CutLockTreeAutomataAlphabet {
