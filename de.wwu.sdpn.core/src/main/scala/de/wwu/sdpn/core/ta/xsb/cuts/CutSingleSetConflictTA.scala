 ...
 */
class CutSingleSetConflictTA[StackSymbol <% HasTermRepresentation](val name: String, cset: scala.collection.Set[StackSymbol]) extends CutLockTreeAutomataAlphabet {
