...
import de.wwu.sdpn.core.analyses.XSBRunner._
...
import de.wwu.sdpn.core.analyses.SingleSetReachability._
...
object SSRBenchmarkRunner {
    ...
    def runSSRAnalysis(props: SDPNProps,testProps:SDPNTestProps) {
    	import testProps._
        import props._
    ...
    def getSSRProp(mcname: String, slicing: Boolean, witness: Boolean): SDPNTestProps = {
        val p0 = SDPNTestProps.get
